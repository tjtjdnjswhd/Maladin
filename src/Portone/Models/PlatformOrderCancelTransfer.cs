...
namespace Portone.Models
{
    ...
    public partial class PlatformOrderCancelTransfer
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public required PlatformPayment Payment { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<PlatformOrderTransferOrderLine> OrderLines { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("cancellation", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public required PlatformOrderTransferCancellation Cancellation { get; set; }
