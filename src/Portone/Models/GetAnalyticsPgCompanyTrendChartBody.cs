namespace Portone.Models
{
    ...
    public partial class GetAnalyticsPgCompanyTrendChartBody
    {
        ...
        [Newtonsoft.Json.JsonProperty("pgCompanies", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<PgCompany> PgCompanies { get; set; }
