namespace Portone.Models
{
    ...
    public partial class CreatePlatformOrderTransferBodyExternalPaymentDetail
    {
        ...
        [Newtonsoft.Json.JsonProperty("orderName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public PlatformPaymentMethodInput Method { get; set; }
