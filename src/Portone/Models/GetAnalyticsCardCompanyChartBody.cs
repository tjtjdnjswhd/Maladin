namespace Portone.Models
{
    ...
    public partial class GetAnalyticsCardCompanyChartBody
    {
        ...
        [Newtonsoft.Json.JsonProperty("cardCompanies", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<CardCompany> CardCompanies { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<CardCompany> ExcludesFromRemainders { get; set; }
