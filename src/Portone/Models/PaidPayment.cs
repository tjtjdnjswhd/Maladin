...
namespace Portone.Models
{
    ...
    public partial class PaidPayment : Payment
    {
        ...
        [Newtonsoft.Json.JsonProperty("pgTxId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PgTxId { get; set; }

        [Newtonsoft.Json.JsonProperty("pgResponse", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
