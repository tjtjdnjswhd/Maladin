namespace Portone.Models
{
    ...
    public partial class PlatformPartnerSettlementFilter
    {
        /// <summary>
        ...
        [Newtonsoft.Json.JsonProperty("transferTypes", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<PlatformTransferType> TransferTypes { get; set; }

        [Newtonsoft.Json.JsonProperty("transferStatuses", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<PlatformTransferStatus> TransferStatuses { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("paymentMethodTypes", Required = Newtonsoft.Json.Required.Always, ItemConverterType = typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        [System.ComponentModel.DataAnnotations.Required]
        public required ICollection<PaymentMethodType> PaymentMethodTypes { get; set; }
        ...
        public PlatformPartnerSettlementFilterKeyword Keyword { get; set; }
