...
namespace Portone.Models
{
    ...
    public partial class ConfirmedPaymentEscrow : PaymentEscrow
    {
        ...
        [Newtonsoft.Json.JsonProperty("isAutomaticallyConfirmed", Required = Newtonsoft.Json.Required.Always)]
        public bool IsAutomaticallyConfirmed { get; set; }
